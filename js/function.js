(function($) {
    ...
    if ($('.testimonial-slider-moon').length) {
        const testimonial_slider_moon = new Swiper('.testimonial-slider-moon .swiper', {
            slidesPerView: 1,
            speed: 2000,
            spaceBetween: 30,
            loop: true,
    ...
    var $hero_item_list_metal = $('.hero-item-list-metal');
    if ($hero_item_list_metal.length) {
        var $hero_item_metal = $hero_item_list_metal.find('.hero-item-metal');

        if ($hero_item_metal.length) {
            $hero_item_metal.on({
                mouseenter: function() {
                    if (!$(this).hasClass('active')) {
                        $hero_item_metal.removeClass('active');
